...
function CreateOrder() {
  ...
  // userName from global ui state
  const {userName, status : addressStatus , error : addressError , position , address} = useSelector(state => state.user);
